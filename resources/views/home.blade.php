        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Table </span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route ('barang.index')}}">Barang</a></li>
                <li class=active><a class="nav-link" href="{{route ('penerima_barang.index')}}">Penerima Barang</a></li>
                <li class=active><a class="nav-link" href="{{route ('supplier.index')}}">Supplier</a></li>
              </ul>
            </li>
